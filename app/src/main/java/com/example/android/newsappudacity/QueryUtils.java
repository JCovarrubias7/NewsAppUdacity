...
public final class QueryUtils {
    ...
    /**
     * Query The Guardian's dataset and return a list of {@link Article} objects.
     */
    public static List<Article> fetchArticleData(String requestUrl) {
        //Create URL object - createURL is defined further down
        URL url = createUrl(requestUrl);

        //Perform HTTP request to the URl and receive a JSON response back
        // makeHttpResponse is defined further down
        ...
        List<Article> articles = extractResultFromJson(jsonResponse);
     ...
     */
    private static List<Article> extractResultFromJson(String articleJSON) {
